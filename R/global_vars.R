utils::globalVariables(
  c(
    ...
    'GENDER_CONCEPT_ID', 'HERITAGE', 'LOGITTEST',
    ...
    'YEAR_OF_BIRTH', 'CHI2Y', 'CHI2Y_P_VALUE', 'cohort_start_date', 'count', 'ordinal',
    ...
    'CONCEPT_IDS_id', 'PARENT_NAME', 'child_id', 'child_name', 'child_prevalence', 'idx',
    'parent_prevalence'
  )
)
