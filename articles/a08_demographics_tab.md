...
The next example derives a few cohort-level summary values from the
bundled `lc500` patient data. These are the same kinds of inputs shown
in the KPI cards and demographic overview panels.
...
The full Demographics tab expands this with cluster-specific summaries
and concept-level age and sex shifts.
